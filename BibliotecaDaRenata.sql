...
--
-- Host: 127.0.0.1    Database: bibliotecadarenata
-- ------------------------------------------------------
...
CREATE TABLE `emprestimos` (
  ...
  `data_devolucao` date GENERATED ALWAYS AS ((`data_emprestimo` + interval 7 day)) STORED,
...
-- Dump completed on 2025-03-23 12:44:09
